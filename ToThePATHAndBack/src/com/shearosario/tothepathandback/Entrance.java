...
public class Entrance implements Parcelable {
	...
	private boolean nybound;
	private boolean njbound;
	private double entrance_lat;
	private double entrance_lon;
	 ...
	 */
	public Entrance(String eid, String sid, double lat, double lon, String nt, int es, int el, int ny,
			int nj)	{
		entrance_id = eid;
		stop_id = sid;
		notes = nt;
	...
	public Entrance(Parcel source) {
		this.entrance_id = source.readString();
		...
		this.entrance_lat = source.readDouble();
		this.entrance_lon = source.readDouble();
	}
	...
	public double[] getEntranceLocation() {
		return new double[]{entrance_lat, entrance_lon};
	}
	...
	public void writeToParcel(Parcel dest, int flags) {
		...
		dest.writeDouble(entrance_lat);
		dest.writeDouble(entrance_lon);
	}

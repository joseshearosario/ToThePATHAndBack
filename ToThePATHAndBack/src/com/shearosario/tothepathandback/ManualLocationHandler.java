...
{		
	...
	{	
		 ...
		 */
		((EditText) activity.findViewById(R.id.origin_manual)).setText("");
		if (latlng == null)
		{
			new AlertDialog.Builder(context)
			.setTitle("Typed Location Does Not Exist")
			.setMessage("The location you entered couldn't be found. You may need to be more or less specific.")
		...
		else
		{
			if (ClosestStationFragment.getSelectedStation() == null)
				...
				new ClosestStationsIntent(new LatLng(latlng[0], latlng[1]), ClosestStationFragment.getSelectedStation(), context, activity, state, county);
		}
	}
}

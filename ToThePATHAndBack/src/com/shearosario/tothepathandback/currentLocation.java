...
public class currentLocation {
	...
	public void createClosestStationsIntent()
	{
		haveLocation = true;
		Intent intent = new Intent (context, ClosestStationsActivity.class);
		intent.putExtra("Current", new double[]{currentLocation.latitude, currentLocation.longitude});
	 ...
	 * 
	 * @see com.shearosario.tothepathandback.MainActivity#currentLocation
	 */
	public LocationListener gpsListener = new LocationListener() {
		...
		public void onLocationChanged(Location location) {
			...
			// Log.d("gpsChanged", "currentLocation: " + currentLocation.latitude + ", " + currentLocation.longitude);
	...
	public LocationListener networkListener = new LocationListener() {
		...
		public void onLocationChanged(Location location) {
			...
			// MainActivity.currentLocation = new LatLng (location.getLatitude(), location.getLongitude());
			//Log.d("networkChanged", "currentLocation: " + currentLocation.latitude + ", " + currentLocation.longitude);
	 ...
	 */
	public currentLocation (Context c, Activity a)
	{
		this.context = c;
		this.activity = a;
		this.getLocation();

...
public class CurrentLocationHandler {
	...
	{	
		String beforeButtonText = (String) ((Button) view.findViewById(R.id.origin_current)).getText();
		((Button) view.findViewById(R.id.origin_current)).setText("Using your current location...");
		...
		((Button) view.findViewById(R.id.origin_current)).setText(beforeButtonText);
		if (ClosestStationFragment.getSelectedStation() == null)
			...
			new ClosestStationsIntent(new LatLng(currentLocation.getLatitude(), currentLocation.getLongitude()),ClosestStationFragment.getSelectedStation(),
					context, activity, originState, originCounty);
	}
	...
	private void getLocation() 
	{
		try {
			...
			if (!isGPSEnabled && !isNetworkEnabled) 
			{
				...
				.setMessage("You currently don't have GPS and/or mobile network location provider turned on.")
	...
	private static void setCurrentLocation(Location currentLocation, int text) 
	{
		String[] currentLocationText = new String[] 
				{"Use your last known (GPS) location", "Use your last known (Network) location",
